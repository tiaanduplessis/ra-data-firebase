        ...
        return resourcesStatus[resourceName].then((function ($await_4) {
            try {
                ...
                switch (type) {
                    ...
                    case UPDATE:
                    case CREATE:
                        shouldCreateUser = admin && admin.path === resourceName && type === CREATE && params.data && params.data.email && params.data.password && admin.validate(params.data);
                        if (shouldCreateUser) {
                            var $Try_1_Post = (function () {
                                try {
                                    return $If_3.call(this);
                        ...
                        function $If_3() {
                            ...
                            return Promise.all(uploads).then(function ($await_9) {
                                try {
                                    ...
                                    return save(itemId, params.data, currentData, resourceName, resourcesPaths[resourceName], firebaseSaveFilter, uploadResults, type === CREATE, metaFieldNames).then(function ($await_10) {
                                        try {
                                            result = $await_10;
                                            return $return(result);
                                        } catch ($boundEx) {
