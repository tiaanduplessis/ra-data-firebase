                        ...
                        function $If_3() {
                            ...
                            return Promise.all(uploads).then(function ($await_8) {
                                try {
                                    ...
                                    return save(itemId, params.data, currentData, resourceName, resourcesPaths[resourceName], firebaseSaveFilter, uploadResults, type === CREATE, metaFieldNames).then(function ($await_9) {
                                        try {
                                            result = $await_9;
                                            return $return(result);
                                        } catch ($boundEx) {
